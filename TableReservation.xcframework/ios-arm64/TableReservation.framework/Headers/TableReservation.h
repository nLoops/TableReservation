...
- (TableReservationAPIAuthResponse *)doCopyAccessToken:(NSString * _Nullable)accessToken expiresIn:(TableReservationInt * _Nullable)expiresIn refreshToken:(NSString * _Nullable)refreshToken tokenType:(NSString * _Nullable)tokenType __attribute__((swift_name("doCopy(accessToken:expiresIn:refreshToken:tokenType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (TableReservationInt * _Nullable)component22 __attribute__((swift_name("component22()")));
...
- (NSString * _Nullable)component5 __attribute__((swift_name("component5()")));
- (NSString * _Nullable)component6 __attribute__((swift_name("component6()")));
- (NSArray<TableReservationApiSlot *> * _Nullable)component7 __attribute__((swift_name("component7()")));
...
- (TableReservationBoolean * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (TableReservationApiSlot *)doCopyIsAvailable:(TableReservationBoolean * _Nullable)isAvailable slot:(NSString * _Nullable)slot __attribute__((swift_name("doCopy(isAvailable:slot:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (TableReservationApiVatResponse *)doCopyVatValue:(TableReservationDouble * _Nullable)vatValue message:(NSString * _Nullable)message ok:(TableReservationBoolean * _Nullable)ok __attribute__((swift_name("doCopy(vatValue:message:ok:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable message __attribute__((swift_name("message")));
...
- (instancetype)initWithTotalAmount:(double)totalAmount referenceNo:(NSString *)referenceNo confirmationMessage:(NSString *)confirmationMessage isFreeBooked:(BOOL)isFreeBooked __attribute__((swift_name("init(totalAmount:referenceNo:confirmationMessage:isFreeBooked:)"))) __attribute__((objc_designated_initializer));
- (double)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (BOOL)component4 __attribute__((swift_name("component4()")));
- (TableReservationReserve *)doCopyTotalAmount:(double)totalAmount referenceNo:(NSString *)referenceNo confirmationMessage:(NSString *)confirmationMessage isFreeBooked:(BOOL)isFreeBooked __attribute__((swift_name("doCopy(totalAmount:referenceNo:confirmationMessage:isFreeBooked:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (double)component1 __attribute__((swift_name("component1()")));
- (TableReservationVat *)doCopyValue:(double)value __attribute__((swift_name("doCopy(value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithIsArabic:(BOOL)isArabic enableLogs:(BOOL)enableLogs jahezToken:(NSString *)jahezToken __attribute__((swift_name("init(isArabic:enableLogs:jahezToken:)"))) __attribute__((objc_designated_initializer));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (BOOL)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (TableReservationHomeReservationEventsInit *)doCopyIsArabic:(BOOL)isArabic enableLogs:(BOOL)enableLogs jahezToken:(NSString *)jahezToken __attribute__((swift_name("doCopy(isArabic:enableLogs:jahezToken:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString *jahezToken __attribute__((swift_name("jahezToken")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReservationDetailsEvents.GetReservations")))
@interface TableReservationReservationDetailsEventsGetReservations : TableReservationReservationDetailsEvents
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)getReservations __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) TableReservationReservationDetailsEventsGetReservations *shared __attribute__((swift_name("shared")));
@end;
...
- (instancetype)initWithReservations:(NSArray<TableReservationReservation *> *)reservations error:(NSString * _Nullable)error isEmpty:(BOOL)isEmpty isLoading:(BOOL)isLoading __attribute__((swift_name("init(reservations:error:isEmpty:isLoading:)"))) __attribute__((objc_designated_initializer));
- (NSArray<TableReservationReservation *> *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (BOOL)component3 __attribute__((swift_name("component3()")));
- (BOOL)component4 __attribute__((swift_name("component4()")));
- (TableReservationReservationDetailsViewState *)doCopyReservations:(NSArray<TableReservationReservation *> *)reservations error:(NSString * _Nullable)error isEmpty:(BOOL)isEmpty isLoading:(BOOL)isLoading __attribute__((swift_name("doCopy(reservations:error:isEmpty:isLoading:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable error __attribute__((swift_name("error")));
